	...
	<div class="container">
		<div class="body_wrap">
			<div id="quest_bar">
					...
					<tbody>
						...
						<tr class="dex">
							...
							<c:if test="${post.getUserID().equals(user.getId()) }">
								<td class="post-edit">
								<a href="deletePost.do?rorq=question&id=${post.getBdID()}">delete</a>
								</td>
							</c:if>
						</tr>
						<tr>
				...
				<div class="sub_header">
					<h1 style="font-size: 1.5rem;">${Integer.parseInt(cnt)} Answers</h1>
				</div>
				<c:if test="${!empty user}">
					<div class="ans-write">
						<form class="m-answer" action="answer.do" method="post">
							<input type="text" id="atitle" name="title" placeholder="title" />
							<textarea id="acontent" name="content" placeholder="content" /></textarea>
							<input type="hidden" name="id" value="${post.getBdID()}">
							<!--  <input type="submit" value="" /> -->
							<button type="submit"></button>
						</form>
					</div>
									...
									<tr>
										...
										<td>
											<div class="summary">
												...
												<div class="excerpt">${item.getContent() }</div>
											</div>
										</td>
									</tr>
								</tbody>
